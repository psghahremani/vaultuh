...
### Overall Flow
To start things off, you'll need to ***create a new encrypted vault***. The encrypted vault is stored as a simple ***GPG encrypted file***. Once you have an encrypted vault, you are free to ***store it under any path and name*** that you may like. The content of the vault can be edited at anytime in order to ***add/remove crendentials***. The vault's ***password can also be changed*** at anytime. Credentials can be fetched with the help fuzzy searching with the option to be either directly ***printed on your terminal*** or simply ***copied into the clipboard***.
